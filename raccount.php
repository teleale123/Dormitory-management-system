...
<p><a href="admin.php"><img src="img/logo.png" align="left" width="150px" height="120px"></a><img src="img/admin.png" align="center" width="490px" height="120px"></p>
</td>
</tr>
<!--End Of Header-->
<!--Main menus-->
...
<br>
    ...
    <?php		
			$admin=mysql_query("select *from users where level='1'");
			$countadmin=mysql_num_rows($admin);
			
			$pro=mysql_query("select *from users where level='3'");
			$countpro=mysql_num_rows($pro);
			
			$pmana=mysql_query("select *from users where level='2'");
