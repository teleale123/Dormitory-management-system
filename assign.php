...
$result1=mysql_query("select * from block where user_id='$user_id'")or die(mysql_error);
...
$batch=$row['batch'];
$faculty=$row['faculty'];
$result2=mysql_query("select * from room where block_no='$block'")or die(mysql_error);
...
<div style="float:right; margin-right:20px; background-color:#cccccc; width:25px;  text-align:center; border-radius:10px; height:12px;"><a href="proctor.php" title="Close"><img src="img/close_icon.gif"></a></div> 
  ...
  <table width="426px" align="center" >
	...
	<td></td>
         ...
         <tr>
	       <td class='para1_text' width="220px"><font color="red">*</font> Sex:</td><td><input type="text"  name="sex" readonly="readonly" value="<?php echo $sexcategory;?>"/></td>
	     </tr>
		 <tr>
	       <td class='para1_text' width="220px"><font color="red">*</font> Batch:</td>
		   <td style="padding-top:12px;"><select name="batchs"  maxlength="5">
		 ...
		 <tr>
		   ...
		   <td style="padding-top:12px;"><select name="facultys"  maxlength="5">
                   <option value='<?php $faculty;?>'><?php echo $faculty;?></option>
                </select></td>
	     </tr>
		 <tr>
	       <td class='para1_text' width="220px"><font color="red">*</font> Block No:</td>
		   <td style="padding-top:12px;"><input type="text" name="block" readonly="readonly" value="<?php echo $block;?>"/></td>
	     </tr>
		 <tr>
	       <td class='para1_text' width="220px"><font color="red">*</font>No. of Rooms:</td>
		   <td style="padding-top:12px;"><input type="text" name="nodorms" value="<?php echo $norooms;?>" readonly="readonly"/></td>
	     </tr>
		 <tr>
	       <td class='para1_text' width="220px"><font color="red">*</font>No. of Beds Per Dorm:</td>
		   <td style="padding-top:12px;"><input type="text" name="nodorm" value="<?php echo $bed;?>" readonly="readonly"/></td>
	     </tr>
...
$r3=$row[4];
$r4=$row[5];
$sql=mysql_query("INSERT INTO students (fname,mname,lname,stud_id,sex,batch,faculty,block_no,room_no)
VALUES
